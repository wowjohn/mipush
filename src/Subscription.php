...
class Subscription extends HttpBase
{
    ...
    {
        $fields = ['registration_id' => $regId, 'topic' => $topic];
    ...
    public function subscribeForRegids($regIdList, $topic, $retries = 1)
    {
        ...
        $fields = ['registration_id' => $jointRegIds, 'topic' => $topic];
    ...
    public function subscribeTopicByAlias($aliasList, $topic, $retries = 1)
    {
        ...
        $fields = ['aliases' => $jointAliases, 'topic' => $topic];
    ...
    {
        $fields = ['registration_id' => $regId, 'topic' => $topic, 'restricted_package_name' => $packageName];
    ...
    public function subscribeForRegidsByPackageName($regIdList, $topic, $packageName, $retries = 1)
    {
        ...
        $fields = ['registration_id' => $jointRegIds, 'topic' => $topic, 'restricted_package_name' => $packageName];
    ...
    public function subscribeTopicByPackageNameAlias($aliasList, $topic, $packageName, $retries = 1)
    {
        ...
        $fields = ['aliases' => $jointAliases, 'topic' => $topic, 'restricted_package_name' => $packageName];
